        ...
        <div class="col-md-6">
            <form @submit.prevent="submitBill" class="form form-horizontal" role="form">
                ...
                <div class="form-group" :class="{'has-error' : formErrors['due_date']}">
                    <label class="control-label col-sm-3">Data Esperada</label>
                    <div class="col-sm-9">
...
<script>
    ...
    export default{
        ...
        computed: {
            formTitle() {
                return this.formType == 'insert' ? 'Nova Conta a Receber' : 'Editar Conta';
            }
        },
        methods: {
            submitBill() {
            ...
            saveBill() {
                ...
                BillStore.save({}, vm.bill).then(response => {
                    ...
                    vm.$router.go({name: 'contas.receber'});
            ...
            back() {
                this.$router.go({name: 'contas.receber'});
            }
        },
        events: {
        ...
        watch: {
            '$route': function() {
                if (this.$route.name == 'contas.receber.nova') {
                    this.bill = {
                        name: '',
                        due_date: '',
                        value: '',
        ...
        created() {
            ...
            if (this.$route.name == "contas.receber.editar") {
            ...
            if (this.$route.name == 'contas.receber.editar' && !this.bill) {
